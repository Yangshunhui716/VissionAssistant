export const PROMPTS = {
  ...
  search: {
    start: (item) => ({ ui: `Đang quét tìm: ${item}...`, tts: `Để tôi tìm ${item}.`, priority: 3 }),
    ...
    invalid: { ui: "Không rõ đồ vật cần tìm.", tts: "Tôi chưa hiểu bạn muốn tìm gì.", priority: 3 }
  },
  ...
  alert: {
    threat: (message) => ({ ui: `⚠️ ${message}`, tts: `Chú ý! ${message}`, priority: 1 }),
    shaking: { ui: "⚠️ Camera không ổn định!", tts: "Cảnh báo! Camera không ổn định!", priority: 2 },
    outFocus: { ui: "⚠️ Camera bị che!", tts: "Cảnh báo! Camera bị che!", priority: 2 }
  },
};